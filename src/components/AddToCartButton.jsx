...
const AddToCartButton = ({ data }) => {
    ...
    try {
        ...
        if (
        error?.response?.data?.message === "Provide token" ||
        ...
        <div className='w-full max-w-[150px]'>
            {
                isAvailableCart ? (
                    ...
                    <button
                        ...
                        className="block ml-auto bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium shadow-sm transition-all duration-200"
                    >
